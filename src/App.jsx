...
const firebaseConfig = (() => {
  ...
  if (!raw) {
    console.error('Firebase config is missing. Please set VITE_FIREBASE_CONFIG in your .env file');
    return null;
  }
  try {
...
if (!firebaseConfig) {
  throw new Error('Firebase configuration is required. Please check your .env file.');
}
